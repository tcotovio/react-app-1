...
test('addTodo should add the passed todo to the list', () => {
    ...
    const newTodo = {id: 3, name: 'Use State to Render UI', isComplete: false}
...
test('findById should return the expected item from an array', () => {
    ...
    const expected = {id: 2, name: 'Create Initial State', isComplete: false}
...
test('toggleTodo should toggle the isComplete prop of a todo', () => {
    const startTodo = {id: 2, name: 'Create Initial State', isComplete: false}

    const expected = {id: 2, name: 'Create Initial State', isComplete: true}
...
test('toggleTodo should not mutate the original', () => {
    const startTodo = {id: 2, name: 'Create Initial State', isComplete: false}
    const result = toggleTodo(startTodo)
...
test('updateTodo should update an item by id', () => {
    ...
    const updatedTodo = {id: 2, name: 'Create Initial State', isComplete: true}
